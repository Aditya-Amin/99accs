...
export default function ProductDetailBreadcrumb({ product }: ProductDetailBreadcrumbProps) {
  const gameLabel = product.game.charAt(0).toUpperCase() + product.game.slice(1);
  return (
          ...
          <div className="col-12">
            <div className="breadcrumb__content">
              <nav className="breadcrumb">
                <span>
                  <Link href={`/product-category/${product.game}`}>{gameLabel}</Link>
                </span>
