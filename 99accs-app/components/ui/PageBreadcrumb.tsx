...
// Reusable breadcrumb-two section. Mirrors the markup used across the HTML
// templates (cart.html / my-account.html / support.html etc.) — same SVG
// separator and section background pattern. Pass the trailing page label
// as `title`; any items before it in `crumbs` render as <Link>s.
export function PageBreadcrumb({
  title,
  crumbs = [{ label: 'Home', href: '/' }],
  bg = '/img/bg/breadcrumb_bg.jpg',
}: Props) {
  return (
    <section
      className="breadcrumb__area-two section__bg"
