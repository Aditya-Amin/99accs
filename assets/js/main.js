...
$('.shop__filter-dropdown-item .dropdown-toggle').on('click', function () {
    let parent = $(this).closest('.shop__filter-dropdown-item');

    parent.find('.dropdown-arrow').toggleClass('active');
});
